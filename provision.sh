...
sudo openssl req -x509 -nodes -days 365 -newkey rsa:2048  -subj "/CN=$1.localhost" -keyout /etc/ssl/private/nginx-selfsigned.key -out /etc/ssl/certs/nginx-selfsigned.crt  > /dev/null 2>&1
